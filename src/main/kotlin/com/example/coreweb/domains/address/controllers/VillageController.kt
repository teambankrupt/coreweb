...
class VillageController @Autowired constructor(
    ...
    fun search(@RequestParam("union_id", required = false) unionId: Long?,
        ...
        val villages: Page<Village> = this.villageService.search(unionId, query, page, size)
    ...
    override fun search(query: String, page: Int, size: Int): ResponseEntity<Page<VillageDto>> {
