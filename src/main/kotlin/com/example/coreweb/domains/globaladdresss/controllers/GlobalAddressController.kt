...
class GlobalAddressController @Autowired constructor(
    ...
    override fun search(@RequestParam("q", defaultValue = "") query: String,
                        ...
                        @RequestParam("sort_direction", defaultValue = "DESC") direction: Sort.Direction): ResponseEntity<Page<GlobalAddressDto>> {
    ...
    override fun update(@PathVariable("id") id: Long,
                        @Valid @RequestBody dto: GlobalAddressDto): ResponseEntity<GlobalAddressDto> {
