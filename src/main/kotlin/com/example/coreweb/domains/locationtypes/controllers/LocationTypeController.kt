...
class LocationTypeController @Autowired constructor(
...
) : CrudControllerV2<LocationTypeDto> {
    ...
    override fun search(@RequestParam("q", defaultValue = "") query: String,
                        ...
                        @RequestParam("sort_direction", defaultValue = "DESC") direction: Sort.Direction): ResponseEntity<Page<LocationTypeDto>> {
    ...
    override fun find(@PathVariable("id") id: Long): ResponseEntity<LocationTypeDto> {
    ...
    override fun create(@Valid @RequestBody dto: LocationTypeDto): ResponseEntity<LocationTypeDto> {
    ...
    override fun update(@PathVariable("id") id: Long,
                        @Valid @RequestBody dto: LocationTypeDto): ResponseEntity<LocationTypeDto> {
